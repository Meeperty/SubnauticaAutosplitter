...
namespace SubnauticaAutosplitter
{
    partial class SubnauticaSettings
    {
        ...
        private void InitializeComponent()
        {
			...
			this.unstuckPauseCheckBox = new System.Windows.Forms.CheckBox();
			...
			this.MainPanel.Controls.Add(this.unstuckPauseCheckBox);
			...
			this.sparseDeathCheckBox.Margin = new System.Windows.Forms.Padding(2);
			...
			this.ionSplitCheckBox.Margin = new System.Windows.Forms.Padding(2);
			...
			this.mountainSplitCheckBox.Margin = new System.Windows.Forms.Padding(2);
			...
			this.rocketSplitCheckBox.Margin = new System.Windows.Forms.Padding(2);
			...
			this.toothSplitChechBox.Margin = new System.Windows.Forms.Padding(2);
			...
			this.gunSplitcheckBox.Margin = new System.Windows.Forms.Padding(2);
			...
			this.endSplitCheckBox.Margin = new System.Windows.Forms.Padding(2);
			this.endSplitCheckBox.Name = "endSplitCheckBox";
			this.endSplitCheckBox.Size = new System.Drawing.Size(269, 24);
			...
			this.startSplitCheckBox.Margin = new System.Windows.Forms.Padding(2);
			...
			// 
			// unstuckPauseCheckBox
			// 
			this.unstuckPauseCheckBox.AutoSize = true;
			this.unstuckPauseCheckBox.Location = new System.Drawing.Point(16, 277);
			this.unstuckPauseCheckBox.Name = "unstuckPauseCheckBox";
			this.unstuckPauseCheckBox.Size = new System.Drawing.Size(282, 24);
			this.unstuckPauseCheckBox.TabIndex = 8;
			this.unstuckPauseCheckBox.Text = "Pause timer during unstuck loading";
			this.unstuckPauseCheckBox.UseVisualStyleBackColor = true;
			// 
			// label1
			// 
			...
			this.label1.Text = "2.0 patches only:";
			// 
			// SubnauticaSettings
			// 
		...
		private CheckBox unstuckPauseCheckBox;
